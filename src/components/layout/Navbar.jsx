      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        <NavLink to="/" className="flex items-center space-x-2 group">
          <div className="w-10 h-10 bg-primary-500 rounded-xl flex items-center justify-center shadow-lg shadow-primary-500/20 group-hover:scale-110 transition-transform">
            <span className="text-white font-black text-xl italic uppercase tracking-tighter">Rx</span>
          </div>
          <span className="text-2xl font-black text-white italic tracking-tight hidden sm:block uppercase">Rollox</span>
        </NavLink>
              ...
              <NavLink
                ...
                className={({ isActive }) => 
                  `flex items-center space-x-2 px-3 py-2 rounded-lg text-sm font-medium transition-colors ${
                    isActive ? 'text-primary-500 bg-primary-500/10' : 'text-slate-400 hover:text-white hover:bg-slate-800'
                  }`
                }
              >
                <Icon size={18} />
